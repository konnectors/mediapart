...
This konnector retrieves your bills from [Mediapart](https://www.mediapart.fr)
...
Mediapart is developed by Cozy Cloud and distributed under the [AGPL v3 license][agpl-3.0].
